...
cleos push action xferqueue addtoq '["eosio.token", "from1", "to1", "2.0000 MAX", "memo"]' -p xferqueue
cleos push action xferqueue addtoq '["eosio.token", "from2", "to1", "2.0000 MAX", "memo"]' -p xferqueue
cleos push action xferqueue addtoq '["eosio.token", "from3", "to1", "2.0000 MAX", "memo"]' -p xferqueue
cleos push action xferqueue addtoq '["eosio.token", "from1", "to1", "2.0000 MAX", "memo"]' -p xferqueue
cleos push action xferqueue addtoq '["eosio.token", "from2", "to1", "2.0000 MAX", "memo"]' -p xferqueue
cleos push action xferqueue addtoq '["eosio.token", "from3", "to1", "2.0000 MAX", "memo"]' -p xferqueue
cleos push action xferqueue addtoq '["eosio.token", "from1", "to1", "2.0000 MAX", "memo"]' -p xferqueue
